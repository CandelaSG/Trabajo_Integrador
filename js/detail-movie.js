                            ...
                            texto += `<article class="conteinerPoster">
                                ...
                                <article class="infoDetail">
                                    <ul class="listaDetail">
                                        ...
                                        <strong><a href="detail-genres.html?genreIdMov=${data.genres[0].id}">${genero1}</strong></a></li>
                                        <li><strong class="decoracion">Running time:</strong>   ${runtime} minutes</li>
                                        <li><strong class="decoracion">Qualification:</strong>     ${vote} <i class="fa-solid fa-star"></i></li> 
                                    </ul> 
                            ...
                            texto += `<article class="conteinerPoster">
                                ...
                                <article class="infoDetail">
                                    <ul class="listaDetail">
                                        <li><strong class="decoracion">Release date:</strong>   ${date}</li>
                                        <li><strong class="decoracion">Genres: </strong>
                                        <strong><a href="detail-genres.html?genreIdMov=${data.genres[0].id}">${genero1}</strong></a>
                                        <strong><a href="detail-genres.html?genreIdMov=${data.genres[1].id}">${genero2}</strong></a></li>
                                        <li><strong class="decoracion">Running time:</strong>   ${runtime} minutes</li>
                                        <li><strong class="decoracion">Qualification:</strong>     ${vote} <i class="fa-solid fa-star"></i></li> 
                                    </ul> 
                            ...
                            texto += `<article class="conteinerPoster">
                                ...
                                <article class="infoDetail">
                                    <ul class="listaDetail">
                                        ...
                                        <li><strong class="decoracion">Genres: </strong>
                                        <strong><a href="detail-genres.html?genreIdMov=${data.genres[0].id}">${genero1}</strong></a>
                                        <strong><a href="detail-genres.html?genreIdMov=${data.genres[1].id}">${genero2}</strong></a>
                                        <strong><a href="detail-genres.html?genreIdMov=${data.genres[2].id}">${genero3}</strong></a></li>
                                        <li><strong class="decoracion">Running time:</strong>   ${runtime} minutes</li>
                                        <li><strong class="decoracion">Qualification:</strong>     ${vote} <i class="fa-solid fa-star"></i></li> 
                                    </ul> 
